...
const { checkIn, checkOut, checkOutBySlot, getParkingSessionBySlot, getParkingSessionsByUser, getAllParkingSessions, repairSlotStatuses } = require('../controllers/parkingController');
...
router.post('/repair-slots', repairSlotStatuses);
